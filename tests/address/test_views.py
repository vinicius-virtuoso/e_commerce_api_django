...
class TestAddress(TestCase):
    ...
    def setUpTestData(cls) -> None:
        cls.client = Client()
        cls.address_create_url = reverse("create_address")
        ...
        cls.user_without_address = User.objects.create_user(**cls.user_data_without_address)
        ...
        cls.address_created = Address.objects.create(**cls.address_data,user=cls.user_created)
    ...
    def test_cant_create_address_if_invalid_fields(self):
        ...
        expected_response = {            
            ...
            "neighbourhood": ["This field may not be blank.", "This field is required."],
        ...
        self.assertIn(response.data["neighbourhood"][0], expected_response["neighbourhood"])

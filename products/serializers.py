...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id','name','description','price','stock', 'discount','slug', 'image_url']
        depth = 1
    ...
    def create(self, validated_data: dict):        
        ...
        if image is None:
            ...
            if cloudinary_response is not None:
                ImageProduct.objects.create(image_url=cloudinary_response, product=product)
            return product
    ...
    def update(self, instance: Product, validated_data: dict): 
        ...
        if image is not None:
            ...
            if cloudinary_response is not None:
                ImageProduct.objects.create(image_url=cloudinary_response, product=instance)
